...
|---|---|---|---|
| 2026-08-18 | [frame-align-null](2026-08-18_frame-align-null/) | *(no numbers yet)* Two questions the bake-off left open: how short can a frame be and still align, and what does an aligner do on audio that does not match at all. Deliverable is **useful-accept rate at 1% false-accept**. Predictions registered before the run; code in `frame_align/`, smoke-tested but not yet run on Emilia | **planned** |
